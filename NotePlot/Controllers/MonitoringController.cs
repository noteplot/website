...
namespace NotePlot.Controllers
{
    public class MonitoringController : Controller
    {
        ...
        public IActionResult MonitoringList(long id)
        {
            ...
            */
            long loginID = LoginController.GetLogin(HttpContext.User); // дл€ настроек по каждому логину в будущем
        ...
        {            
            if (HttpContext.User.Identity.IsAuthenticated)
            {
                ...
                return BadRequest("Ќет аутентификации!"); // TODO: обработать ошибку аутентификации
        }
